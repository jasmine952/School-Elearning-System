                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['save1'])) {
                                ...
                                $error_query = mysqli_query($conn, "select * from teacher_student where teacher_id='$teacher_id' and student_id='$student_id'") or die(mysqli_error($conn));
                            ...
                            <?php
                                    ...
                                    mysqli_query($conn, "insert into teacher_student (teacher_id,student_id) values('$teacher_id','$student_id')") or die(mysqli_error($conn));
