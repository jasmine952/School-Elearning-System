...
<div class="navbar  navbar-inverse">
    <div class="navbar-inner">
        <div class="footerindex">
            <center><img width="25" height="25" src="admin/img/chmsc.png">&nbsp;Polytechnic  E-Learning System modified <i class="fa fa-heart"></i> by : Abraham jasmine  </center>
        </div>
        <!-- modal -->
        <!-- mission -->
        <div id="mission" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="alert alert-info"><strong>Polytechnic Mission</strong></div>
                <p>
        ...
        <div id="vision" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="alert alert-info"><strong>Polytechnic Vision</strong></div>

                <p>FPN ExCELS: Excellence, Competence, and Educational Leaderhip in Science and Technology.</p>
                ...
                To be able to prove to people that students also know how to cope up with the development in technology this will provide an easier way of teaching and a better form of learning.
