        ...
        <div class="row-fluid">
            ...
            <div class="span9">
                ...
                <div class="alert alert-info">
                    ...
                    <strong><i class="icon-phone-sign icon-large"></i>&nbsp;Contacts!</strong>&nbsp;
                </div>
                <div class="hero-unit-3">

                    <div class="row-fluid">
                        <div class="span12">
                            <div class="alert alert-success">  Information </div>
                            ...
                            <div class="row-fluid">
                                <div class="span6">
                                    ...
                                    <p><i class="icon-circle"></i>&nbsp;Rectors Office - 495-4064(telefax)</p>
                                ...
                                <div class="span6">
                                    ...
                                    <p><i class="icon-circle"></i>&nbsp;Information Supply - 495-3767</p>
                                   <p><i class="icon-circle"></i>&nbsp;ICT Unit - 712-6144/712-6459</p>
