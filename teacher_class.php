...
<body>
    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="span9">
                <a href="teacher_add_class.php" class="btn btn-success"><i
                        class="icon-plus-sign icon-large"></i>&nbsp;Add Class</a>
                <br></br>
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"
                        ...
                        <tbody>
                            <?php
                            $query = mysqli_query($conn, "select * from class where teacher_id = '$session_id'") or die(mysqli_error($conn));
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td><a rel="tooltip" title="View Class" id="v<?php echo $class_id; ?>"
                                        href="class.php<?php echo '?id=' . $class_id; ?>" class="btn btn-info">&nbsp;<i
                                            class="icon-group icon-large"></i>&nbsp;<?php echo $row['course_id']; ?></a>
                                </td>
                                <td><?php echo $row['subject_id']; ?></td>

                                <td width="50">
                                    <a rel="tooltip" title="Delete Subject" id="d<?php echo $class_id; ?>"
                                        href="#course_id<?php echo $class_id; ?>" role="button" data-toggle="modal"
                                        class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;</a>

                                </td>
                                <!-- user delete modal -->
                                <div id="course_id<?php echo $class_id; ?>" class="modal hide fade" tabindex="-1"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="delete_class.php<?php echo '?id=' . $class_id; ?>"
