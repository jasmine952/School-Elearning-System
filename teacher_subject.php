            ...
            <div class="span9">
                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            <?php
                            $teacher_subject_query = mysqli_query($conn, "select * from teacher_suject where teacher_id='$session_id'") or die(mysqli_error($conn));
                            $teacher_row = mysqli_fetch_array($teacher_subject_query);
                            $subject_id = $teacher_row['subject_id'];

                            $query = mysqli_query($conn, "select * from subject where subject_id  in (select subject_id from teacher_suject where teacher_id='$session_id')") or die(mysqli_error($conn));
